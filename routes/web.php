...
use App\Http\Controllers\Admin\GameserverCloudPlanController;
...
Route::middleware(['auth', 'verified', 'brand.domain'])->group(function () {
    ...
    Route::get('gaming/cloud', [GamingController::class, 'cloudIndex'])->name('gaming.cloud.index');
    Route::get('gaming/cloud/checkout/{plan}', [GamingController::class, 'cloudCheckout'])->name('gaming.cloud.checkout');
    Route::post('gaming/cloud/checkout', [GamingController::class, 'storeCloudCheckout'])->middleware('billing.profile')->name('gaming.cloud.checkout.store');
    Route::get('gaming/cloud/subscriptions', [GameserverCloudSubscriptionController::class, 'index'])->name('gaming.cloud.subscriptions.index');
    Route::get('gaming/cloud/subscriptions/{subscription}', [GameserverCloudSubscriptionController::class, 'show'])->name('gaming.cloud.subscriptions.show');
    Route::get('gaming/cloud/subscriptions/{subscription}/egg-variables', [GameserverCloudSubscriptionController::class, 'eggVariables'])->name('gaming.cloud.subscriptions.egg-variables');
    Route::post('gaming/cloud/subscriptions/{subscription}/servers', [GameserverCloudSubscriptionController::class, 'storeServer'])->name('gaming.cloud.subscriptions.servers.store');
    Route::post('gaming/cloud/subscriptions/{subscription}/servers/power-all', [GameserverCloudSubscriptionController::class, 'powerAll'])->name('gaming.cloud.subscriptions.servers.power-all');
    Route::post('gaming/cloud/subscriptions/{subscription}/servers/{game_server_account}/power', [GameserverCloudSubscriptionController::class, 'powerServer'])->name('gaming.cloud.subscriptions.servers.power');
    Route::delete('gaming/cloud/subscriptions/{subscription}/servers/{game_server_account}', [GameserverCloudSubscriptionController::class, 'destroyServer'])->name('gaming.cloud.subscriptions.servers.destroy');
    Route::put('gaming/cloud/subscriptions/{subscription}/servers/{game_server_account}/resources', [GameserverCloudSubscriptionController::class, 'updateServerResources'])->name('gaming.cloud.subscriptions.servers.resources.update');
    ...
    Route::post('gaming-accounts/{game_server_account}/connect-domain', [GamingAccountController::class, 'storeConnectDomain'])->name('gaming-accounts.connect-domain.store');
    Route::get('gaming-accounts/{game_server_account}/subdomain/check', [GamingAccountController::class, 'checkSubdomain'])->name('gaming-accounts.subdomain.check');
    Route::put('gaming-accounts/{game_server_account}/subdomain', [GamingAccountController::class, 'updateSubdomain'])->name('gaming-accounts.subdomain.update');
    ...
    Route::post('gaming-accounts/{game_server_account}/api/console/command', [GamingAccountController::class, 'consoleCommand'])->name('gaming-accounts.api.console.command');
    Route::get('gaming-accounts/{game_server_account}/api/files/list', [GamingAccountController::class, 'filesList'])->name('gaming-accounts.api.files.list');
    Route::get('gaming-accounts/{game_server_account}/api/files/contents', [GamingAccountController::class, 'filesContents'])->name('gaming-accounts.api.files.contents');
    Route::post('gaming-accounts/{game_server_account}/api/files/write', [GamingAccountController::class, 'filesWrite'])->name('gaming-accounts.api.files.write');
    Route::get('gaming-accounts/{game_server_account}/api/files/download', [GamingAccountController::class, 'filesDownload'])->name('gaming-accounts.api.files.download');
    Route::post('gaming-accounts/{game_server_account}/api/files/create-folder', [GamingAccountController::class, 'filesCreateFolder'])->name('gaming-accounts.api.files.create-folder');
    ...
    Route::post('gaming-accounts/{game_server_account}/api/schedules', [GamingAccountController::class, 'schedulesCreate'])->name('gaming-accounts.api.schedules.create');
    Route::get('gaming-accounts/{game_server_account}/api/schedules/{schedule}', [GamingAccountController::class, 'schedulesShow'])->name('gaming-accounts.api.schedules.show');
    Route::delete('gaming-accounts/{game_server_account}/api/schedules/{schedule}', [GamingAccountController::class, 'schedulesDelete'])->name('gaming-accounts.api.schedules.delete');
    Route::post('gaming-accounts/{game_server_account}/api/schedules/{schedule}/execute', [GamingAccountController::class, 'schedulesExecute'])->name('gaming-accounts.api.schedules.execute');
    Route::post('gaming-accounts/{game_server_account}/api/schedules/{schedule}/tasks', [GamingAccountController::class, 'scheduleTasksCreate'])->name('gaming-accounts.api.schedules.tasks.create');
    Route::delete('gaming-accounts/{game_server_account}/api/schedules/{schedule}/tasks/{task}', [GamingAccountController::class, 'scheduleTasksDelete'])->name('gaming-accounts.api.schedules.tasks.delete');
...
Route::middleware(['admin.domain', 'auth', 'verified', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('hosting-servers/{hostingServer}/pterodactyl-nests', [PterodactylEggController::class, 'nests'])->name('hosting-servers.pterodactyl-nests.index');
    Route::get('hosting-servers/{hostingServer}/pterodactyl-nests/{nest}/eggs', [PterodactylEggController::class, 'eggs'])->name('hosting-servers.pterodactyl-nests.eggs.index');
