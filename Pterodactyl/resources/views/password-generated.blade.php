...
<div class="bg-background-secondary dark:bg-background-secondary/80 border border-neutral rounded-lg p-6 mb-6 shadow-md">
    <div class="mb-4">
        <h3 style="font-size:1.25rem; font-weight:600; color:var(--text-primary);">Password Generated</h3>
    </div>
    <p style="color:var(--text-secondary); font-size:0.875rem; margin-bottom:1.5rem;">
        A new secure password has been created and applied to your server. Save this password in a secure location before leaving this page.
    </p>
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <div class="relative">
                <input type="password" id="generatedPasswordField" value="{{ $password }}" readonly 
                ...
                <button type="button" onclick="togglePasswordVisibility('generatedPasswordField', this)" 
