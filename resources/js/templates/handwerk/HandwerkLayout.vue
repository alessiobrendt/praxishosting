        ...
        >
            <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 sm:px-6">
                ...
                <nav class="flex items-center gap-4 sm:gap-6" aria-label="Hauptnavigation">
                    ...
                    <a
                        href="#kontakt"
                        class="rounded px-3 py-1.5 text-sm font-semibold uppercase tracking-wide transition-colors"
            ...
            <div class="mx-auto max-w-5xl px-4 sm:px-6">
                <div class="flex flex-col items-center justify-between gap-3 text-center sm:flex-row sm:text-left">
                    ...
                    <div class="flex gap-4">
                        <a
                            href="/impressum"
                            class="text-xs font-medium uppercase tracking-wider text-white/90 transition-colors hover:text-white"
                        >
                            Impressum
                        </a>
                        <a
